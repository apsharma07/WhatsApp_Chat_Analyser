...
def fetch_stats(selected_user, df):
    ...
    links = [url for message in df['message'] for url in extract.find_urls(message)]  # Number of links shared
...
def emoji_helper(selected_user, df):
    ...
    emojis = [c for message in df['message'] for c in message if emoji.is_emoji(c)]  # Fixed issue
